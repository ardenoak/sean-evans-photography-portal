...
const navigation: NavItem[] = [
  ...
  { name: 'Lead Management', href: '/admin/leads', icon: '👥' },
  { name: 'Experience & Pricing', href: '/admin/packages', icon: '📦' },
  { name: 'Session Management', href: '/admin/sessions', icon: '📸' },
  { name: 'Client Relations', href: '/admin/clients', icon: '🤝' },
];
