                ...
                {timeline.length === 0 ? (
                  ...
                  <div className="space-y-4">
                    {timeline.map((item) => (
                      <div
                        key={item.id}
                        className="border border-warm-gray/20 rounded-lg p-4"
                      >
                        <div className="flex items-start justify-between">
                          <div className="flex items-start space-x-4">
                            ...
                            <div>
                              <h4 className={`font-medium ${item.is_completed ? 'text-warm-gray line-through' : 'text-charcoal'}`}>
                                {item.task_name}
                              </h4>
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <span className={`px-2 py-1 text-xs rounded-full ${getAutomationStatusColor(item.automation_status)}`}>
