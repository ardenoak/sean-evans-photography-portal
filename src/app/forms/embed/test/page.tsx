...
export default function TestForm() {
  ...
  useEffect(() => {
    ...
    style.textContent = `
      ...
      #__next,
      #__next-error-refresh,
      [data-nextjs-error-reload],
      div[data-nextjs-hmr-indicator],
      a[href*="_next"],
      div:has(svg[alt="Vercel logomark"]),
      a:has(svg[alt="Next.js logomark"]),
      [data-nextjs-script-loader],
      ...
      div:has(a[href="https://nextjs.org"]),
      a[href="https://nextjs.org"],
      div:has(svg[viewBox="0 0 180 180"]),
      ...
      /* Hide all fixed positioned elements that might be Next.js indicators */
      body > div[style*="position: fixed"] {
        display: none !important;
      }
      /* Hide any element with Next.js logo dimensions */
    ...
    // Additional DOM manipulation to remove Next.js elements
    const removeNextElements = () => {
      // Remove any elements with Next.js related content
      const nextElements = document.querySelectorAll('a[href*="nextjs"], div:has(a[href*="nextjs"]), [data-nextjs], div[style*="position: fixed"]');
  ...
  const formConfig = {
    ...
    settings: {
      thankYouMessage: "Thank you for testing our form! In production, this would save to our database."
    }
  };
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-3">
            <h1 className="text-2xl font-bold text-slate-900">
              Professional Contact Form (Test)
            </h1>
