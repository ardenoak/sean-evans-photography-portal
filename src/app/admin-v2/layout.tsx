            ...
            <div className="flex justify-between items-center py-6">
              <div className="flex items-center space-x-4">
                <div className="w-8 h-8 bg-gold rounded-full flex items-center justify-center">
                  <span className="text-charcoal font-bold text-sm">SE</span>
                </div>
                <div>
                  <h1 className="text-xl font-light text-ivory tracking-wide">Admin Portal</h1>
                  <span className="text-gold/80 text-xs font-light tracking-wider uppercase">Sean Evans Photography</span>
                </div>
              </div>
