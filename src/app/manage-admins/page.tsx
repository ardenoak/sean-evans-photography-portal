      ...
      if (error) {
        ...
        try {
          ...
          const emailData = {
            ...
            from_name: 'Tally Photography Management',
            subject: 'Welcome to Tally Photography Management Team',
            invitation_url: invitationUrl,
            role: newAdmin.role,
            invited_by: 'Tally Photography Management',
            expires_in_days: 7
          };
